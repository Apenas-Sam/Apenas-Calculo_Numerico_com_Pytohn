...
matriz = np.array([[1,3,-2],
                   [2,-1,1],
                   [4,3,-5]],dtype='float64')
vetor_constante = np.array([[3],[12],[6]],dtype='float64')

sl = SistemaLinear(matriz=matriz,vetor_constante=vetor_constante,tipo='coeficiente')
#sl.cramer()
#sl.triangular_matriz()
#sl.triangular_matriz()
#sl.eliminacao_gaussiana()
#sl.convergencia_linhas()
#sl.gauss_jacobi()



M1 = np.array([[10,2,1],[1,5,1],[2,3,10]],dtype='float64')
bM1 = np.array([[7],[-8],[6]],dtype='float64')
sl2 = SistemaLinear(matriz=M1,vetor_constante=bM1)
#sl2.convergencia_linhas()
#sl2.cramer()
#sl2.gauss_jacob(tol=1/(10**9))
#sl2.gauss_seidel()
#sl2.convergencia_sassenfeld()

#sl2.gauss_jacob(tol=1/(10**2))
A = np.array([
    [3,-1,1],
    [1,-4,2],
    [-1,-1,3]
...
#sl3 = SistemaLinear(matriz=A)
#sl3.convergencia_linhas()

B = np.array([[2,1],[3,4]])
b = np.array([[1],[-1]])

#sl4 = SistemaLinear(matriz=B,vetor_constante=b)
#sl4.gauss_jacob(tol=1/(10**9),iteracoes=20,ctr='erro')

M2 = np.array([[8,2,-1,0],
               [2,-4,0,0],
               [0,-1,8,-1],
               [0,0,-1,4]],dtype='float64')
b2 = np.array([[1],[1],[1],[1]])
#sl4 = SistemaLinear(matriz=M2,vetor_constante=b2)
#sl4.gauss_jacobi(iteracoes=50)

M3 = np.array([[5,1,1],
               [3,4,1],
               [3,3,6]],dtype='float64')
b3 = np.array([[5],[6],[0]],dtype='float')

sl5 = SistemaLinear(matriz=M3,vetor_constante=b3)
sl5.cramer()
sl5.gauss_seidel(tol=10**(-9),iteracoes=50)
